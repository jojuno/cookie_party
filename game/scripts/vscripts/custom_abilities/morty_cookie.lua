...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function morty_cookie:CastFilterResultTarget( hTarget )
...
function morty_cookie:GetCustomCastErrorTarget( hTarget )
	--[[if IsServer() and hTarget:IsChanneling() then
...
function morty_cookie:OnAbilityPhaseStart()
    print("[morty_cookie:OnAbilityPhaseStart()] called")
...
function morty_cookie:OnSpellStart()
    print("[morty_cookie:OnSpellStart()] called")
	-- unit identifier
    ...
    local callback = function()
        print("[morty_cookie:OnSpellStart()] callback called")
        -- precache damage
        local damageTable = {
            -- victim = target,
        ...
        for _,enemy in pairs(enemies) do
            print("[morty_cookie:OnSpellStart()] enemy found")
            -- apply damage
