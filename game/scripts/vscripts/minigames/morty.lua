...
function GameMode:Morty()
    ...
    local mortyPlayerID = math.random(0, GameMode.maxNumPlayers - 1)
    ...
    Timers:CreateTimer("checkFinished", {
        ...
        callback = function()
            ...
            if not morty:IsAlive() then
                ...
                print("id of most damage attacker: " .. mostDamageAttacker:GetPlayerID())
            ...
            elseif numHuntersAlive == 0 then
                ...
                PlayerResource:ReplaceHeroWith(winnerID, "npc_dota_hero_snapfire", PlayerResource:GetGold(winnerID), PlayerResource:GetTotalEarnedXP(winnerID))
                GameMode:EndGame()
                --stop thinker
                return nil
            end
